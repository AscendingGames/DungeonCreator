...
class Room(val roomElements : ObservableList<RoomElement> = ObservableList(mutableListOf()), var position : Vector2 = Vector2.Zero.cpy(), var type : RoomType = RoomType.NORMAL) {
    var isVisited = false
